...
async function main() {
    ...
    await prisma.filament.createMany({
        data: [
            { tenant_id: TENANT_ID, brand: 'Voolt3D', material_type: 'PLA', color: 'Marrom Velvet', purchase_price: 88.10, shipping_cost: 7.50, stock_quantity: 1, purchase_date: new Date('2025-10-02T00:00:00Z') },
            ...
            { tenant_id: TENANT_ID, brand: 'JAYO', material_type: 'PLA', color: 'Preto Matte', purchase_price: 91.00, shipping_cost: 0.00, stock_quantity: 5, purchase_date: new Date('2025-10-29T00:00:00Z') },
            { tenant_id: TENANT_ID, brand: '3D Fila', material_type: 'PLA', color: 'Verde', purchase_price: 86.00, shipping_cost: 10.25, stock_quantity: 1, purchase_date: new Date('2025-10-29T00:00:00Z') },
            { tenant_id: TENANT_ID, brand: '3D Fila', material_type: 'PLA', color: 'Vermelho', purchase_price: 86.00, shipping_cost: 10.25, stock_quantity: 1, purchase_date: new Date('2025-10-29T00:00:00Z') },
            { tenant_id: TENANT_ID, brand: '3D Fila', material_type: 'PLA', color: 'Azul Claro', purchase_price: 86.00, shipping_cost: 10.25, stock_quantity: 1, purchase_date: new Date('2025-10-29T00:00:00Z') },
            { tenant_id: TENANT_ID, brand: '3D Fila', material_type: 'PLA', color: 'Branco', purchase_price: 86.00, shipping_cost: 10.25, stock_quantity: 1, purchase_date: new Date('2025-10-29T00:00:00Z') },
        ]
    });
